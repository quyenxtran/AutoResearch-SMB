...
BRIDGE_SYMBOLS = {
    ...
    "agent_results": [
        ...
        "safe_result_metric",
        "effective_flow",
        "stream_components_from_outlets",
        "composition_metrics_from_result",
    ...
    "agent_evidence": [
        ...
        "markdown_focused_excerpt",
        "build_heuristics_context",
        "hypothesis_matcher",
        "failure_recovery_context",
        "apply_flow_adjustments",
        "build_task_from_counterproposal",
    ],
    "agent_db": [
        "open_sqlite_db",
        "persist_result_to_sqlite",
        "record_convergence_snapshot",
        "sqlite_convergence_context",
        "sqlite_targeted_query",
        "sqlite_history_context",
        "sqlite_record_count",
        "sqlite_layout_trend_table",
        "read_research_tail",
        "append_research",
        "reset_research_run_section",
        "append_iteration_research",
        "append_result_research",
        "append_final_research",
